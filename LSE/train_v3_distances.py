...
for ep in range(1, nepochs+1):
    ...
    for ib in idx_batches:
        ...
        t0 = time.time()
        step_wise_loss = train_step(batch, batch_aug, trainable_vars)
...
# np_ori = enc_ori.numpy()

# np_aug = enc_aug.numpy()

# np_input1 = input1.numpy()[:,]

# #%%

# np_lhand_f = lhand_f.numpy()
# np_latent_lhand = latent_lhand.numpy()

# np_rhand_f = rhand_f.numpy()
# np_latent_rhand = latent_rhand.numpy()
